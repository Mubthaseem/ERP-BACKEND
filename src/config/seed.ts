...
import { Account, Expense } from '../modules/accounting/accounting.model.js';
import { Organization } from '../modules/organization/organization.model.js';
import { Employee } from '../modules/hrm/hrm.model.js';
...
import { generateZatcaTlvQrCode } from '../modules/sale/zatca.js';
...
export const seedDatabaseIfEmpty = async () => {
  try {
    ...
    logger.info('🌱 Seeding Saudi Arabia ERP Master Data into MongoDB...');
    ...
    logger.info('✅ Real Master Data seeded successfully into MongoDB!');
  } catch (error: any) {
